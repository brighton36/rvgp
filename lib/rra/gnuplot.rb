...
module RRA
  class Gnuplot
        ...
        case type
          ...
          when :stacked_area
            ...
            if opts[:is_stacked]
              ...
              # Data related:
              RRA::Gnuplot::DataSet.new(dataset, 'plot for [i=%d:2:-1]' % num_cols, [
              ...
              # Data:
              RRA::Gnuplot::DataSet.new(dataset, 'plot for [i=2:%d]' % num_cols, [
          ...
          when :column_and_lines
            ...
            # Data related:
            RRA::Gnuplot::DataSet.new(dataset, 'plot for [i=2:%d]' % [num_cols-2], [
    ...
    class DataSet
      def initialize(dataset, cmd, plot_attrs, opts = {})
        @dataset, @cmd, @plot_attrs, @opts = dataset, cmd, plot_attrs, opts
      end
      ...
      def to_gplot
        # Gnuplot insists on calling this, in order to embed the dataset,
        # using "plot '-'" syntax. Which, we don't use.
        nil
      end
