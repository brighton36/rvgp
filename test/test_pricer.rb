...
class TestPricer < Minitest::Test
  ...
  def test_price_format1
    ...
    assert_raises(RRA::Pricer::NoPriceError) { price_on p, '1900-01-01', 'FEQTX', 'USD' }
    assert_raises(RRA::Pricer::NoPriceError) { price_on p, '2004-06-20', 'FEQTX', '$' }
    assert_raises(RRA::Pricer::NoPriceError) { price_on p, '2004-06-21', 'FEQTX', 'USD' }
    ...
    assert_raises(RRA::Pricer::NoPriceError) { price_on p, '1900-01-01', 'USD', 'FEQTX' }
    assert_raises(RRA::Pricer::NoPriceError) { price_on p, '2004-06-20', '$', 'FEQTX' }
    assert_raises(RRA::Pricer::NoPriceError) { price_on p, '2004-06-21', 'USD', 'FEQTX' }
  ...
  def test_price_format2
    ...
    assert_raises(RRA::Pricer::NoPriceError) { price_on p, '2019-12-31', 'EUR', 'USD' }
    assert_raises(RRA::Pricer::NoPriceError) { price_on p, '2019-12-31', 'USD', 'EUR' }
