...
class TestUtilities < Minitest::Test
  ...
  def test_months_through_dates
    string_to_date = lambda{|s| Date.strptime s}

    assert_equal %w( 2019-01-01 2019-02-01 2019-03-01 2019-04-01 2019-05-01 
      2019-06-01 2019-07-01 2019-08-01 2019-09-01 2019-10-01 2019-11-01 
      2019-12-01 ).collect(&string_to_date), 
      months_through_dates( *%w(
        2019-01-01 2019-02-01 2019-03-01 2019-04-01 2019-05-01 2019-06-01 
        2019-07-01 2019-08-01 2019-09-01 2019-10-01 2019-11-01 2019-12-01 
        2019-01-01 2019-02-01 2019-03-01 2019-04-01 2019-05-01 2019-06-01 
        2019-07-01 2019-08-01 2019-09-01 2019-10-01 2019-11-01 2019-12-01
      ).collect(&string_to_date) )
