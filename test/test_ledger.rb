...
# These tests ensure that RRA::Ledger parses the xml output, as we'd expect.
...
class TestLedger < Minitest::Test
  def test_balance_multiple_with_empty
    ...
    ], RRA::Ledger::Output::Register.new(asset_contents('ledger_total_monthly_liabilities_with_empty.xml'), opts)
    ...
    ], RRA::Ledger::Output::Register.new(asset_contents('ledger_total_monthly_liabilities_with_empty2.xml'), opts)
  end
